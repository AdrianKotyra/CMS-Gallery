        ...
        <div class="row">
            ...
            <?php
                ...
                <?php
                    ...
                    // <!-- SELECT COMMENTS -->
                   // <!-- SELECT COMMENTS -->
                    // $query1 = "SELECT * from users where user_role='Admin'";
                    // $query_select_users1 = mysqli_query($connection, $query1);
                    // while ($row= mysqli_fetch_array($query_select_users1)) {
                    //     $admins = $row["user_namee"];
                    // }
